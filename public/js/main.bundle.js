...
$__System.register('8', ['7', '9', 'a', 'b'], function (_export) {
	var Velocity, $, _createClass, _classCallCheck, Nav;
...
(function() {
var _removeDefine = $__System.get("@@amd-helpers").createDefine();
define("9", ["f"], function(main) {
  return main;
});

_removeDefine();
})();
$__System.register('10', ['9', 'a', 'b'], function (_export) {
	var $, _createClass, _classCallCheck, Paper, Logo;
		...
		execute: function () {
			...
			Logo = (function () {
					...
					window.onload = function () {
						...
						Paper.project.importSVG('images/foret-music.svg', {
							onLoad: function onLoad(group) {
								...
								group.onMouseMove = _this.onMouseMove;
							}
						});
				...
				_createClass(Logo, [{
					...
					key: 'createPath',
					value: function createPath(pathData, pointData) {
						if (pathData && pointData.length > 1) {
							var path = new Paper.Path(pathData);
							var startPoint = path.add(new Paper.Point(pointData));
...
$__System.register('1', ['7', '8', '10', 'a', 'b'], function (_export) {
	var Velocity, Nav, Logo, _createClass, _classCallCheck, Main, App;
			...
			Main = (function () {
				...
				_createClass(Main, [{
					...
					value: function animate() {
						...
						$('.ft-wrapper').velocity({ opacity: 1 }, 2000, function () {
							// Initialise NavIcon
							navIcon.bindEvents();
						});
					}
